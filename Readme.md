...
The repository's boostrapper will set up your environment for you. There will be some things you need pre-installed on Windows environments.
...
## _Quick Start Guide (Source Compile)_
...
[^1]: This application is being developed in WSL2 (Ubuntu) for now.
